...
import { getAllVendors, insertIssue, type Vendor } from '@/db/modules/maintenance';
...
export default function NewIssueScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScreenHeader title={t('new_issue_title')} onBack={() => router.back()} />
