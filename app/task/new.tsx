// New task screen — keyboard-aware form. Saves to SQLite on "Create task".
...
export default function NewTaskScreen() {
  ...
  // Android: imperative dialog API (avoids the dismiss-on-unmount crash).
  // iOS: toggle showDatePicker to render the inline spinner component.
  function openDatePicker() {
    ...
    DateTimePickerAndroid.open({
      ...
      onChange: (_ev, selectedDate) => {
        ...
        // Chain into time picker after date is confirmed
        DateTimePickerAndroid.open({
          value: selectedDate,
          mode: 'time',
          is24Hour: false,
  ...
  return (
    ...
    >
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        {/* iOS-only inline date+time spinner — Android uses the imperative API above */}
...
const styles = StyleSheet.create({
  ...
  memberScroll: { marginHorizontal: -spacing[7], paddingHorizontal: spacing[7] },
  ...
  pickerOptionActive: { borderBottomColor: colors.line2 },
